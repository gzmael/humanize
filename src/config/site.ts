...
export const siteConfig = {
  ...
  keywords: [
    ...
    'Brejo Santo',
    'Ceará',
    'dermatologista em Brejo Santo',
    'oftalmologia em Brejo Santo',
    'cirurgia vascular em Brejo Santo',
    'ortopedista em Brejo Santo',
    'traumatologista em Brejo Santo',
    'neurocirurgião em Brejo Santo',
    'medicina estética em Brejo Santo',
    'ginecologista em Brejo Santo',
    'fisioterapeuta em Brejo Santo',
    'tratamento de feridas em Brejo Santo',
    'gastroenterologista em Brejo Santo',
    'endoscopia digestiva em Brejo Santo',
    'colonoscopia em Brejo Santo',
    'pediatra em Brejo Santo',
    'nutricionista em Brejo Santo',
    'psicólogo em Brejo Santo',
    'psiquiatra em Brejo Santo',
    'fonoaudióloga em Brejo Santo',
    'urologista em Brejo Santo',
    'mastologista em Brejo Santo',
    'cirurgia de mama em Brejo Santo',
    'tricologista em Brejo Santo',
    'hipertrofia',
    'emagrecimento',
    'performance',
    'medicina do esporte em Brejo Santo',
    'otorrinolaringologista em Brejo Santo',
    'ultrassonografista geral em Brejo Santo',
    'doppler em Brejo Santo',
    'cirurgia de catarata em Brejo Santo',
    'cirurgia de pterígio em Brejo Santo',
    'cirurgia de calázio em Brejo Santo',
